...
$(document).on('click', '.btnR', function(e) {
    ...
    var raizroute = '../controlador/contProduccion.php?accion=';
    if ($(this).val() == 'btnPDF') {
        var type = 2;
    ...
    if ($(this).attr('form') == '_dia') {
        if (dia) {
            ...
            if (hoy < fech1) {
                ...
                var route = raizroute + 'reporteProduccion&tipo=' + type + '&fecha1=' + dia + '&fecha2=' + dia + '&rango=DIARIO';
        ...
        if (hoy < fech) {
            ...
            var route = raizroute + 'reporteProduccion&tipo=' + type + '&fecha1=' + mano + '-' + mes + '-01&fecha2=' + mano + '-' + mes + '-31&rango=MENSUAL';
            success(type, route, corr);
        }
        ...
        if (anno < parseInt(ano)) {
            ...
            var route = raizroute + 'reporteProduccion&tipo=' + type + '&fecha1=' + ano + '-01-01&fecha2=' + ano + '-12-31&rango=ANUAL';
            success(type, route, corr);
        }
        ...
        if (dias_entre(df, di) > 0) {
            ...
            if (fech > hoy) {
                ...
                var route = raizroute + 'reporteProduccion&tipo=' + type + '&fecha1=' + di + '&fecha2=' + df + '&rango=DIARIO';
                success(type, route, corr);
            }
        } else {
            $('#di').focus();
        ...
        if (hoy < fech1) {
            ...
            if ((parseInt(amf) - parseInt(ami) > 0) || (parseInt(amf) - parseInt(ami) == 0 && parseInt(mf) - parseInt(mi) > 0)) {
                var route = raizroute + 'reporteProduccion&tipo=' + type + '&fecha1=' + ami + '-' + mi + '-01&fecha2=' + amf + '-' + mf + '-31&rango=MENSUAL';
                success(type, route, corr);
            } else {
                $('#mensajeReporte').css('color', 'red').html(incorr);
            }
        ...
        if (anno < parseInt(ai)) {
            ...
            if (parseInt(af) - parseInt(ai) > 0) {
                var route = raizroute + 'reporteProduccion&tipo=' + type + '&fecha1=' + ai + '-01-01&fecha2=' + af + '-12-31&rango=ANUAL';
                success(type, route, corr);
            } else {
                $('#mensajeReporte').css('color', 'red').html(incorr);
            }
