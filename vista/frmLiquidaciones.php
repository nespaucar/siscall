...
<script src="../assets/js/scriptLiquidacion.js"></script>
<div class="row">
    <br>
    <div class="col-lg-12">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-12">
                        <h4><i class="glyphicon glyphicon-thumbs-up"></i> &nbsp;Liquidaciones</h4>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                ...
                <hr>
                <form class="form-horizontal" role="form" id="_idproducto">
                    <div class="form-group">
                        <label for="cboProductos" class="control-label col-md-1">
                            PRODUCTO
                        </label>
                        <div class="col-md-8">
                            <select class="form-control input-sm" name="cboProductos" id="cboProductos">
                            </select>
                        </div>
                    </div>
                </form>
